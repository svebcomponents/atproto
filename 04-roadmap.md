...
- ~~**svebcomponents alpha status**: we're building on our own alpha tooling — expect to fix upstream bugs as they surface~~ **Updated 2026-08**: upstream publishes steady 0.x releases (currently build 0.7.1 / ssr 0.8.0) including every fix dogfooded here; remaining exposure is ordinary early-version churn, not alpha breakage.
