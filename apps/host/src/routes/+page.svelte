...
<header class="site-header">
  ...
  <nav aria-label="Main navigation">
    ...
    <span class="icon-links">
      ...
      <a
        class="icon-link npm"
        href="https://www.npmjs.com/package/@svebcomponents/atproto.comments"
        target="_blank"
        rel="noreferrer"
        aria-label="@svebcomponents/atproto.comments on npm"
      >
        <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
          <path
            fill="currentColor"
            d="M0 7.334v8h6.666v1.332H12v-1.332h12v-8H0zm6.666 6.664H5.334v-4H3.999v4H1.335V8.667h5.331v5.331zm4 0v1.336H8.001V8.667h5.334v5.332h-2.669zm12.001 0h-1.33v-4h-1.336v4h-1.335v-4h-1.33v4h-2.671V8.667h8.002v5.331zM10.665 10H12v2.667h-1.335V10z"
          />
        </svg>
      </a>
    </span>
  ...
  <section id="self-host" class="section self-host">
    <div class="self-host-copy">
      ...
      <div class="resource-note">
        <strong>Live Thread Data via Spacedust &amp; Constellation</strong>
        <p>
          The bridge sends live thread updates via SSE to connected users,
          leveraging the incredible <code>spacedust</code> project. Showing
          readers which posts they have already liked or reposted is a backlink
          question, answered by its sibling <code>constellation</code>. Both are
          part of
...
<style>
  ...
  /* The npm mark only fills the middle third of its viewBox, so it needs a
     larger box than the GitHub mark to read at the same optical weight. */
  .icon-link.npm svg {
    width: 1.3rem;
    height: 1.3rem;
  }
  ...
  @media (max-width: 850px) {
    .site-header nav a:not(.icon-link) {
      display: none;
    }
